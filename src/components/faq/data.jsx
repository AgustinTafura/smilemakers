export const data = [
    {
        q: '¿Quiénes pueden utilizar Alineadores Invisibles?',
        r: [
            'Hoy en día el 90 % de los problemas de alineación dentaria pueden ser resueltos mediante ortodoncia invisible. Los alineadores realizan fuerzas digitalmente calculadas y de baja intensidad ideales para corregir cualquier tipo de caso.',
    ...
    {
        q: '¿Qué ocurre si se rompe alguno de mis Alineadores?',
        r: [
            ...
            'En estos casos comunícate de inmediato con nosotros para que hagamos la reposición rápidamente.'
        ]
    },
    {
        ...
        r: [
            ...
            'Sin embargo, la utilización de las placas protegerán el esmalte de tus dientes de la acción nociva de éstos productos. Por este motivo es tan importante que higienices tus alineadores SMILE MAKERS a diario y con los productos recomendados.',
            'De esta forma tus alineadores se van a ver siempre limpios y translucidos.'
        ]
    },
    {
    ...
    {
        q: '¿Cuánto tiempo debo utilizar cada alineador?',
        r: [
            'Son super cómodos, están confeccionados con materiales flexibles de excelente calidad.',
            'Podes usarlos todo el día, solo deberás quitártelos para comer o cepillarte los dientes.'
        ]
    },
    {
